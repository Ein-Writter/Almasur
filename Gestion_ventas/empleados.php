...
// FALTA ESTA LÍNEA: Consultar la tabla de usuarios (o empleados)
$usuarios = $conn->query("SELECT id, nombre, email, usuario, rol FROM usuarios ORDER BY nombre ASC");

// Validación por si la consulta falla
if (!$usuarios) {
    die("Error en la consulta: " . $conn->error);
}
if (!isset($_SESSION['usuario_rol']) || $_SESSION['usuario_rol'] !== 'Administrador') {
    // Si no es admin, lo mandamos al menú con un mensaje de error
