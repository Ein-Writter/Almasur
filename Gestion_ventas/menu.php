...
<main class="main-content">
    ...
    <div class="dashboard-grid">
        <div class="card-stats">
            ...
            <div class="stat-data">
                <span class="stat-title">Tasa del Día (BCV)</span>
                <h2 class="stat-value">Bs. <?php echo number_format($tasa_actual, 2); ?></h2>
            </div>
        </div>

        <?php 
            // Solo redirige si es admin, sino, el enlace no hace nada
            $link_stock = ($rol_u == 'admin') ? 'reportes.php' : '#'; 
        ?>
        <a href="<?php echo $link_stock; ?>" class="card-stats" style="text-decoration: none; transition: transform 0.2s;">
            ...
            <div class="stat-data">
                ...
                <?php if($rol_u == 'admin'): ?>
                    <small style="color: #f87171;">Click para ver reporte →</small>
                <?php endif; ?>
            </div>
        </a>
        ...
        <div class="card-stats">
            ...
            <div class="stat-data">
                ...
                <h2 class="stat-value"><?php echo ucfirst($rol_u); ?></h2>
            </div>
        </div>
    </div>
